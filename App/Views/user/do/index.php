...
<html lang="pt">
	...
	<body class="form">
		...
		<form action="http://<?php echo APP_HOST; ?>/user/do" method="post">
		<div class="form">
			<div id="username-field" class="field-wrapper input">
				<input id="password" name="password" autofocus maxlength="20" autocomplete="off" type="password" class="form-control" placeholder="Senha">
			</div>
		...
		<script src="http://<?php echo APP_HOST; ?>/public/assets/js/authentication/form.js"></script>
	</body>
</html>