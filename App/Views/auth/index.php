...
<html lang="pt">
	...
	<body class="form">
		...
		<form action="http://<?php echo APP_HOST; ?>/auth/login" method="post">
		<div class="form">
			<div id="username-field" class="field-wrapper input">
				<input id="username" name="username" autofocus maxlength="20" autocomplete="off" type="text" class="form-control" placeholder="Login">
			</div>
			<div class="d-sm-flex justify-content-between">
				<div class="field-wrapper">
					<button type="submit" class="btn btn-primary" value="">Próximo ></button>
				</div>
			</div>
		</div>
		</form>
