...
class UserController extends Controller
{
    ...
    public function do()
    {
        ...
        if (!empty($user)){
            ...
            $this->redirectExtern(APP_HOST.'/index.php?ctl=Usuario&act=autenticar&token='.$user->getToken().$cod->getChave());
    ...
    public function sms()
    {
        ...
        {
            // Criar o cookie na máquina com validade de 7 dias
            setcookie('TOKEN', $user->getToken(), (time() + (7 * 24 * 3600)),'/');
            // Criar o cookie na máquina com validade de 7 dias
            setcookie('KEY', $cod->getChave(), (time() + (7 * 24 * 3600)),'/');
